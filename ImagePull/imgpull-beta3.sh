...
# Pull all required images for beta.3 release
...
docker pull registry.na.semarchy.net/semarchy-release/docker-billing-service:1.7.2
...
docker pull registry.na.semarchy.net/semarchy-release/docker-log-explorer:1.1.1
docker pull registry.na.semarchy.net/semarchy-release/docker-secret-manager:1.1.2
docker pull registry.na.semarchy.net/semarchy-release/docker-site-admin:1.2.0
docker pull registry.na.semarchy.net/semarchy-release/docker-user-profile:1.1.1
docker pull registry.na.semarchy.net/semarchy-release/docker-welcome:1.2.0
